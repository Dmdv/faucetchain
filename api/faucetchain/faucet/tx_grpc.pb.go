...
const (
	Msg_UpdateParams_FullMethodName  = "/faucetchain.faucet.Msg/UpdateParams"
	Msg_RequestTokens_FullMethodName = "/faucetchain.faucet.Msg/RequestTokens"
)
...
func (c *msgClient) RequestTokens(ctx context.Context, in *MsgRequestTokens, opts ...grpc.CallOption) (*MsgRequestTokensResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_RequestTokens_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMsgServer) RequestTokens(context.Context, *MsgRequestTokens) (*MsgRequestTokensResponse, error) {
...
func _Msg_RequestTokens_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_RequestTokens_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
