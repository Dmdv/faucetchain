...
import (
	...
	faucetchainsimulation "faucetchain/x/faucetchain/simulation"
	"faucetchain/x/faucetchain/types"
)

// avoid unused import issue
var (
	_ = faucetchainsimulation.FindAccount
	_ = rand.Rand{}
	_ = sample.AccAddress
	_ = sdk.AccAddress{}
...
func (AppModule) GenerateGenesisState(simState *module.SimulationState) {
	...
	faucetchainGenesis := types.GenesisState{
		Params: types.DefaultParams(),
		// this line is used by starport scaffolding # simapp/module/genesisState
	}
	simState.GenState[types.ModuleName] = simState.Cdc.MustMarshalJSON(&faucetchainGenesis)
}
...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		faucetchainsimulation.SimulateMsgRequestTokens(am.accountKeeper, am.bankKeeper, am.keeper),
	))
